  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-slate-100">
      <div className="flex flex-col items-start gap-4">
        <div className="text-8xl font-bold bg-gradient-to-r from-slate-500 to-green-400 bg-clip-text text-transparent">Error 404!</div>
        <Link to="/">
      ...
      >
        ...
        ></path>
        <circle cx="183.705" cy="391.21" r="12.96" fill="#b9d4db"></circle>
        <circle cx="193.109" cy="357.024" r="6.72" fill="#b9d4db"></circle>
        <circle cx="219.723" cy="392.65" r="9.6" fill="#b9d4db"></circle>
        <circle cx="170.969" cy="212.701" r="15.42" fill="#b9d4db"></circle>
        <circle cx="141.504" cy="201.718" r="8.032" fill="#b9d4db"></circle>
        <circle cx="148.882" cy="174.415" r="4.633" fill="#b9d4db"></circle>
        <circle cx="174.529" cy="177.693" r="11.107" fill="#b9d4db"></circle>
        <circle cx="438.988" cy="137.917" r="15.42" fill="#b9d4db"></circle>
        <circle cx="463.523" cy="118.249" r="8.032" fill="#b9d4db"></circle>
        <circle cx="494.205" cy="162.323" r="6.952" fill="#b9d4db"></circle>
        <circle cx="483.183" cy="138.58" r="4.633" fill="#b9d4db"></circle>
        <circle cx="467.22" cy="158.92" r="11.107" fill="#b9d4db"></circle>
      </svg>  
    </div>
  );
};
